...
export default function ResultsPage({ answers, showConfetti }: ResultsPageProps) {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-3xl font-semibold mb-6">Thank you for completing the survey!</h2>
      ...
      <div className="flex flex-col gap-4 mb-8 w-full max-w-md mx-auto">
        <Button
          asChild
          size="lg"
          className="bg-teal-500 hover:bg-teal-600 text-white text-base sm:text-lg py-3 px-6 w-full"
        >
        ...
        <Button
          ...
          size="lg"
          variant="outline"
          className="bg-white bg-opacity-10 text-white border-white border-opacity-20 hover:bg-white hover:bg-opacity-20 text-base sm:text-lg py-3 px-6 w-full"
        >
          <Link href="/portfolio-analysis">Review Portfolio Analysis</Link>
        </Button>
      </div>
      <div className="bg-indigo-800 bg-opacity-40 p-4 sm:p-6 rounded-lg backdrop-blur-md border border-white border-opacity-10">
        <h3 className="text-xl font-semibold mb-4 text-white">Your Responses</h3>
